                            ...
                            <div class="col-sm-12 col-md-6 mh-footer-address">
                                <div class="col-sm-12 xs-no-padding">
                                    <div class="mh-address-footer-item dark-bg shadow-1 media wow fadeInUp"
                                        ...
                                        <div class="each-info media-body">
                                            <h4>Address</h4>
                                            <address>
                                                Moti Pur, Muzaffer Pur Bihar, <br>
                                                India, 843111
                                            </address>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12 xs-no-padding">
                                    <div class="mh-address-footer-item media dark-bg shadow-1 wow fadeInUp"
                                        ...
                                        <div class="each-info media-body">
                                            <h4>Email</h4>
                                            <a href="mailto:yourmail@email.com">alokk986963@email.com</a><br>
                                            <a href="mailto:yourmail@email.com">eralokgautam9@email.com</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 xs-no-padding">
                                    <div class="mh-address-footer-item media dark-bg shadow-1 wow fadeInUp"
                                        ...
                                        <div class="each-info media-body">
                                            <h4>Phone</h4>
                                            <a href="+91 773090744">+91 7783090744</a><br>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <div class="text-left text-xs-center">
                                            <p>All right reserved Siful Islam @ 2026</p>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
...
<!-- Mirrored from maha-cv-resume-bootstrap.vercel.app/home-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 15 Mar 2026 14:44:16 GMT -->
