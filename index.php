            ...
            <div class="row section-separator xs-column-reverse vertical-middle-content home-padding">
                <div class="col-sm-6">
                    <div class="mh-header-info">
                        ...
                        <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Alok Kumar </h2>
                        <h4 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">Website Designer
                        </h4>

                        <ul>
                            <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s"><i
                                    class="fa fa-envelope"></i><a href="mailto:">alokk986963@email.com</a></li>
                            <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s"><i
                                    class="fa fa-phone"></i><a href="callto:">+91 7783090744</a></li>
                            <li class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s"><i
                                    class="fa fa-map-marker"></i>
                                <address>Muzaffer Pur, Bihar, India, 843111</address>
                            </li>
                        </ul>
                ...
                <div class="col-sm-6">
                    <div class="hero-img wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                        <div class="img-border">
                            <img src="assets/images/hero1.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row section-separator">
            ...
            <div class="col-sm-12 col-md-6">
                <div class="mh-about-inner">
                    ...
                    <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s">Hello, I’m Alok Kumar, a Web
                        Designer & Developer from India. I create responsive and modern websites using HTML, CSS,
                        JavaScript, React, and Tailwind CSS. I have experience in live projects and focus on clean
                        design and user-friendly experience.</p>
        ...
        <div class="row section-separator">
            ...
            <div class="col-sm-4">
                <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s"
                    ...
                    <h3>UI Design</h3>
                    <p>
                        I create clean, modern, and responsive UI designs that improve user experience. I use HTML, CSS,
                        JavaScript, and Tailwind CSS to build mobile-friendly, professional interfaces.
                    </p>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s"
                    ...
                    <p>
                        I develop modern and responsive websites using HTML, CSS, JavaScript, React, Tailwind CSS, and
                        Bootstrap. I have basic knowledge of PHP, Node.js, MySQL, and MongoDB.
                    </p>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="mh-service-item shadow-1 dark-bg wow fadeInUp" data-wow-duration="0.8s"
                    ...
                    <p>
                        I am a beginner in app development, learning to build simple and user-friendly applications
                        using modern technologies, while improving my skills and gaining practical project experience.
                    </p>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    <div class="mh-single-project-slide-by-side row">
                        ...
                        <div class="col-sm-12 mh-featured-item">
                            <div class="row">
                                <div class="col-sm-7">
                                    <div class="mh-featured-project-img shadow-2 wow fadeInUp" data-wow-duration="0.8s"
                                        data-wow-delay="0.2s">
                                ...
                                <div class="col-sm-5">
                                    <div class="mh-featured-project-content">
                                        ...
                                        <h2 class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">Wrap
                                        </h2>
                                        <span class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">Design
                                            & Development</span>
                                        <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                            I am a passionate Web Developer with strong interest in creating modern,
                                            responsive and user-friendly websites.
                                            I have completed my BCA and I love working on real-world projects that
                                            enhance my coding skills.
                                            I enjoy learning new technologies and building creative web solutions.
                                            I am always eager to improve my knowledge and contribute to innovative
                                            projects.
                                        </p>
                                        <a href="#" class="btn btn-fill wow fadeInUp" data-wow-duration="0.8s"
                                        ...
                                        <div class="mh-testimonial mh-project-testimonial wow fadeInUp"
                                            ...
                                            <blockquote>
                                                <q> This platform perfectly matches my learning journey as a Web
                                                    Developer.
                                                    It helps me explore new technologies while improving my practical
                                                    coding skills
                                                    through real-world projects.</q>
                                                <cite>- Alok Kumar </cite>
                                            </blockquote>
                                            <blockquote>
                                                <q>Creative platform that perfectly matches my passion for web
                                                    development,
                                                    helping me learn new technologies while building real-world projects
                                                    and improving my coding skills.</q>
                                                <cite>- Alok Kumar </cite>
                                            </blockquote>
                                            <blockquote>
                                                <q> Well-organized structure that supports my coding style,
                                                    helping me write clean code while learning new technologies
                                                    and improving my development skills.</q>
                                                <cite>- Alok Kumar </cite>
                                            </blockquote>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-5">
                                    <div class="mh-featured-project-content">
                                        ...
                                        <span class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                            UI & UX Design</span>
                                        <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                            I design and develop clean, modern, and user-friendly interfaces with a
                                            strong focus on UI/UX principles.
                                            My goal is to create seamless digital experiences that are visually
                                            appealing and easy to use.
                                            As a passionate Web Developer, I enjoy working on responsive layouts,
                                            improving user interaction,
                                            and continuously learning new technologies to enhance usability and
                                            performance.
                                        </p>
                                        <a href="#" class="btn btn-fill wow fadeInUp" data-wow-duration="0.8s"
                                            data-wow-delay="0.7s">View Details</a>
                                ...
                                <div class="col-sm-5">
                                    <div class="mh-featured-project-content">
                                        ...
                                        <span class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.6s">
                                            My Experience</span>
                                        <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                                            As a passionate Web Developer, I have gained hands-on experience in building
                                            responsive and user-friendly websites.
                                            I enjoy working on real-world projects that help me improve my coding skills
                                            and problem-solving abilities.
                                            I am always eager to learn new technologies and enhance my knowledge in
                                            UI/UX and modern web development.
                                            My focus is to create clean, efficient, and visually appealing web
                                            solutions.
                                        </p>
                                        <a href="#" class="btn btn-fill wow fadeInUp" data-wow-duration="0.8s"
                                            data-wow-delay="0.7s">View Details</a>
                    ...
                    <div class="mh-education">
                        ...
                        <div class="mh-education-deatils">
                            ...
                            <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.3s">
                                <h4>10th From <a href="#">Bihar School Examination Board.</a></h4>
                                <div class="mh-eduyear">2018-2020</div>
                                <p>I have completed my 10th from Bihar Board. During my studies, I developed a strong
                                    interest in technology and web development, which motivated me to learn and build my
                                    skills in this field. </p>
                            </div>
                            <!-- Education Institutes-->
                            <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.5s">
                                <h4>12th From <a href="#">Bihar School Examination Board. </a></h4>
                                <div class="mh-eduyear">2020-2022</div>
                                <p>I have completed my 12th from Bihar Board. During my studies, I developed a
                                    strong interest in technology and web development, which motivated me to learn and
                                    improve my skills in this field. </p>
                            </div>
                            <!-- Education Institutes-->
                            <div class="mh-education-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.6s">
                                <h4>BCA From <a href="#">Aryabhatta Knowledge University. </a></h4>
                                <div class="mh-eduyear">2022-2025</div>
                                <p>I have completed my Bachelor of Computer Applications (BCA) from Aryabhatta Knowledge
                                    University. During my studies,
                                    I developed a strong interest in technology and web development.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mh-work">
                        ...
                        <div class="mh-experience-deatils">
                            ...
                            <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.4s">
                                <h4>UI Designer <a href="#">SAM Softech Consultancy pvt.ltd</a></h4>
                                <div class="mh-eduyear">2025-2026</div>
                                <span>Responsibility :</span>
                                <ul class="work-responsibility">
                                    <li><i class="fa fa-circle"></i>Validate CSS/PhotoShop</li>
                            ...
                            <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.6s">
                                <h4> Development<a href="#"> SAM Softech Consultancy pvt.ltd</a></h4>
                                <div class="mh-eduyear">2025-2026</div>
                                <span>Responsibility :</span>
                                <ul class="work-responsibility">
                                    <li><i class="fa fa-circle"></i>Validate HTML/CSS/JavaScript.etc</li>
                                    <li><i class="fa fa-circle"></i>Live Project Work</li>
                                    <li><i class="fa fa-circle"></i>Project Management</li>
                                </ul>
                            </div>
                            <!-- Education Institutes-->
                            <div class="mh-work-item dark-bg wow fadeInUp" data-wow-duration="0.8s"
                                data-wow-delay="0.7s">
                                <h4>React <a href="#"> SAM Softech Consultancy pvt.ltd</a></h4>
                                <div class="mh-eduyear">2025-2026</div>
                                <span>Responsibility :</span>
                                <ul class="work-responsibility">
                                    <li><i class="fa fa-circle"></i>Validate Tailwind CSS/ Bootstrap</li>
                                    <li><i class="fa fa-circle"></i>Node.js/Mongo DB/SQL</li>
                                    <li><i class="fa fa-circle"></i>Project Management</li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row section-separator">
                <div class="each-quates col-sm-12 col-md-6">
                    ...
                    <p class="wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.4s">I love coding and working on
                        new projects. I am always ready to learn and improve my skills by building creative and
            ...
            <div class="row section-separator">
                    ...
                    <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.3s">
                        ...
                        <div class="blog-inner">
                            ...
                            <div class="mh-blog-post-info">
                                <ul>
                                    <li><strong>Post On</strong><a href="#">24.11.25</a></li>
                                    <li><strong>By</strong><a href="#">Alok Gautam</a></li>
                                </ul>
                            </div>
                            <p>It is a well known fact that a developer focuses on clean coding practices while building
                                responsive websites and enhancing overall user experience</p>
                            <a href="#">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4">
                    <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.5s">
                        ...
                        <div class="blog-inner">
                            <h2><a href="#">Proportion are what’s really needed</a></h2>
                            <div class="mh-blog-post-info">
                                <ul>
                                    <li><strong>Post On</strong><a href="#">28.02.2026</a></li>
                                    <li><strong>By</strong><a href="#">Alok Gautam</a></li>
                                </ul>
                            </div>
                            <p>It is a well known fact that a developer is focused on building user friendly websites
                                while improving performance and design consistently</p>
                            <a href="#">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12 col-md-4">
                    <div class="mh-blog-item dark-bg wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.7s">
                        ...
                        <div class="blog-inner">
                            <h2><a href="#">Mounts of paper work to remember the way</a></h2>
                            <div class="mh-blog-post-info">
                                <ul>
                                    <li><strong>Post On</strong><a href="#">14.01.26</a></li>
                                    <li><strong>By</strong><a href="#">Alok Gautam</a></li>
                                </ul>
                            </div>
                            <p>It is a well known fact that a developer enjoys creating scalable applications while
                                solving problems and improving skills through practical experience</p>
                            <a href="#">Read More</a>
                        </div>
                    </div>
                </div>
